...
public class Producer {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        config.put("bootstrap.servers", "broker:9092");
        config.put("acks", "all");
    ...
    //$
    // kafka-console-consumer --bootstrap-server broker:9092     --topic mytopic     --from-beginning     --formatter kafka.tools.DefaultMessageFormatter     --property print.key=true     --property print.value=true     -- property key.deserializer=org.apache.kafka.common.serialization.StringDeserializer     --property value.deserializer=org.apache.kafka.common.serialization.StringSerializer
